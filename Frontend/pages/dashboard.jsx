            ...
            <div>
              ...
              <div className="border p-4">
                ...
                <div className='space-x-3 md:space-x-3 text-center pt-4'>
                  ...
                  <button onClick={() => {checkIn()}} className='bg-teal-400 py-4 px-4 mt-4 rounded-xl hover:bg-teal-500 transition ease-linear duration-200'>Check In </button>
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="border p-4">
                <p>
                One benefit of renting a premium vehicle is the absence of maintenance and repair expenditures. A rented car does not require maintenance. This means that when you rent a luxury vehicle, the rental company is in charge of maitenance and upkeeps
                </p>
                <div className='space-x-4 md:space-x-3 text-center'>
                  <button className='bg-teal-400 py-3 px-4 mt-4 rounded-xl hover:bg-teal-500 transition ease-linear duration-200'> Check Out </button>
                  <button className='bg-teal-400 py-3 px-4 mt-4 rounded-xl hover:bg-teal-500 transition ease-linear duration-200'>Check In </button>
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="border p-4">
                <p>
                Rental cars are one of the most reliable transportation systems in the world. People prefer rental cars over any other mode of transportation. Tourists and the first time visitors often rely on these cars and other local transportation.
                </p>
                <div className='space-x-4 md:space-x-3 text-center pt-4'>
                  <button className='bg-teal-400 py-3 px-4 mt-4 rounded-xl hover:bg-teal-500 transition ease-linear duration-200'>Check Out </button>
                  <button className='bg-teal-400 py-3 px-4 mt-4 rounded-xl hover:bg-teal-500 transition ease-linear duration-200'>Check In </button>
                </div>
              </div>
