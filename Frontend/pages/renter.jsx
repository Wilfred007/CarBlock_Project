        ...
        <div className='container w-8/12 mx-auto'>
          ...
          <div className='mt-16 grid grid-cols-1 gap-5 md:grid-cols-3'>
            ...
            <div>
              ...
              <div className='space-x-4 md:space-x-3 text-center mt-8'>
                <Link href="/dashboard" className='bg-teal-400 py-3 px-8 rounded-xl hover:bg-teal-500 transition ease-linear duration-200 mt-5'>Proceed to Dashboard </Link>
                </div>
            </div>
          </div>
        </div>
